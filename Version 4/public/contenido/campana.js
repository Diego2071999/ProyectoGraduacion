$(document).ready(function () {
    ...
    var table = $('#productTable').DataTable({
        ...
        "columns": [
            // Paciente Detalles
            {
                "data": "paciente", // Cambiar a 'paciente' en lugar de 'Paciente'
                "title": "Paciente",
        ...
        `;
            ...
            {
                "data": "medicamento", // Cambiar a 'medicamento' en lugar de 'medicamento'
                "title": "Medicamento",
                "render": function (data, type, row) {
                    return `
        ...
        `;
            ...
            // Receta Detalles
            {
                "data": "detalleReceta", // Cambiar a 'detalleReceta' en lugar de 'recetas'
        ...
        `;
            ...
            <button class="view-btn btn-sm m-1" onclick="abrirModal(
                ...
                '${row.detalleReceta.dosis_diaria}', 
                '${row.detalleReceta.tiempo_consumo}', 
                '${row.detalleReceta.fecha_fin}', 
                ${row.detalleReceta.id}, // Receta ID
    ...
    $('#productTable tbody').on('click', '.btn-reabastecer', function () {
        ...
        var recetaId = data.detalleReceta.id; // Asegúrate de que el ID esté en el objeto recetas
        ...
        abrirModal(data.paciente, data.medicamento, recetaId, data.detalleReceta.tiempo_consumo, data.detalleReceta.fecha_fin, 1, medicamentoId, pacienteId);
    });
